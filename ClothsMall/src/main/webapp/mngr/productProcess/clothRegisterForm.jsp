...
<form id="upForm1" action="<%=request.getContextPath()%>/mg/clothRegisterPro.do" method="post" enctype="multipart/form-data">
	<div id="clothRegistForm" class="box">
		<table>
			...
			<td><input id="cloth_name" name="cloth_name" type="text" size="50" placeholder="옷이름"	maxlength="50"></td>
			</tr>
			<tr>
			<td><label for="cloth_price">가격</label> </td>
			<td><input id="cloth_price" name="cloth_price" type="text" size="10" placeholder="가격" maxlength="9">원</td>
			</tr>
			<tr>
			<td><label for="cloth_count">수량</label> </td>
			<td><input id="cloth_count" name="cloth_count" type="text" size="10" placeholder="수량" maxlength="5">개</td>
			</tr>
			<tr>
			<td><label for="cloth_brand">브랜드</label> </td>
			<td><input id="cloth_brand" name="cloth_brand" type="text" size="50" placeholder="브랜드" maxlength="50"></td>
			</tr>
			<tr>
			...
			<td><textarea id="cloth_content" name="cloth_content" rows="13" cols="50"></textarea></td>
			</tr>
			<tr>
			<td><label for="discount_rate">할인율</label> </td>
			<td><input id="discount_rate" name="discount_rate" type="text" size="5" placeholder="10" maxlength="2"></td>
			</tr>
		</table>
		<div id="registBDiv">
