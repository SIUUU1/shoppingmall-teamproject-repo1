...
<script src="<%=request.getContextPath()%>/mngr/productProcess/clothUpdate.js?v=1"></script>
...
<form id="upForm1" action="<%=request.getContextPath()%>/mg/clothUpdatePro.do" method="post" enctype="multipart/form-data">
	<div id="clothUpdateForm" class="box">
		<table>
			...
			<td><input id="cloth_price" name="cloth_price" type="text" size="10" placeholder="가격" maxlength="9"
			value="${cloth.cloth_price}">원</td>
			</tr>
			<tr>
			<td><label for="cloth_count">수량</label> </td>
			<td><input id="cloth_count" name="cloth_count" type="text" size="10" placeholder="수량" maxlength="5"
			value="${cloth.cloth_count}">개</td>
			</tr>
			<tr>
			<td><label for="cloth_brand">브랜드</label> </td>
			<td><input id="cloth_brand" name="cloth_brand" type="text" size="50" placeholder="브랜드" maxlength="50"
			value="${cloth.cloth_brand}"></td>
			</tr>
			<tr>
			...
			<td><input id="discount_rate" name="discount_rate" type="text" size="5" placeholder="10" maxlength="2" 
			value="${cloth.discount_rate}"></td>
			</tr>
		</table>
		<div id="updateBDiv">
			<input type="button" id="updateCloth" value="옷수정">
		</div>
	</div>
</form>