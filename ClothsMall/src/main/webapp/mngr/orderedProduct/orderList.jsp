					...
					<div class="receiptList">
						...
						<table class="address buylist">
							...
							<tr>
								...
								<td width="150"><select name="state_${thisId}">
										<option value="준비중"
											<c:if test="${receiptList.state == '준비중'}">selected</c:if>>준비중</option>
										<option value="배송중"
											<c:if test="${receiptList.state == '배송중'}">selected</c:if>>배송중</option>
										<option value="배송완료"
