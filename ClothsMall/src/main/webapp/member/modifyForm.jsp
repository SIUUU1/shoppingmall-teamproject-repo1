...
<link rel="stylesheet" href="/ClothsMall/member/css/modify_style.css" />
...
<div id="regForm" class="box">
	...
	<table>
		...
		<tr>
			...
			<td><input id="member_passwd" name="member_passwd"
				type="password" size="20" maxlength="16"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input id="member_name" name="member_name" type="text"
				size="20" maxlength="5" value="${m.getMember_name()}"></td>
		</tr>
		<tr>
			<td><label for="member_postal_code">우편번호</label></td>
			<td>
				<div class="input-group">
					<input id="member_postal_code" name="member_postal_code"
						type="text" size="10" maxlength="6"
						value="${m.getMember_postal_code()}">
		...
		<tr>
			...
			<td><input id="member_address" name="member_address" type="text"
				size="30" maxlength="50" value="${m.getMember_address()}" readonly></td>
		</tr>
		<tr>
			<td><label for="member_detailed_address">상세주소</label></td>
			<td><input id="member_detailed_address"
				name="member_detailed_address" type="text" size="30" maxlength="50"
				value="${m.getMember_detailed_address()}"></td>
		</tr>
		<tr>
