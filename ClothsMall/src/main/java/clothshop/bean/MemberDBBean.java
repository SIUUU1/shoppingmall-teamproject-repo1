...
public class MemberDBBean {
    ...
    public int userCheck(String id, String passwd){
		...
		try {
            ...
            pstmt = conn.prepareStatement(
            	"select member_passwd from member where member_id = ?");
    ...
    // 회원 전체 리스트 호출
    public List<LogonDataBean> getMemberAll() throws Exception {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LogonDataBean member = null;
		...
		try {
			...
			while (rs.next()) {
				...
				member.setMember_id(rs.getString("member_name"));
				member.setMember_id(rs.getString("reg_date"));
				member.setMember_id(rs.getString("member_address"));
				member.setMember_id(rs.getString("member_postal_code"));
				member.setMember_id(rs.getString("member_detailed_address"));
				member.setMember_id(rs.getString("member_tel"));
				member.setMember_id(rs.getString("member_gender"));
				member.setMember_id(rs.getString("member_grade"));
