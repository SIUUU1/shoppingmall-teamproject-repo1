...
public class ClothRegisterProAction implements CommandAction {
	...
	public String requestPro(HttpServletRequest request, HttpServletResponse response) throws Throwable {
		...
		try {
			...
			while (files.hasMoreElements()) {
				// input 태그의 속성이 file 인 태그의 name 속성값 :파라미터이름
		...
		clothProcess.insertCloth(cloth);
		request.setAttribute("cloth_category", cloth_category);
		return "/mngr/productProcess/clothRegisterPro.jsp";
	}
